...
var displayMaps = function displayMaps(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FuemFpa2MiLCJhIjoiY2wxdmh2enZjMG1qNzNmbzVoNHd1eHdvNCJ9.iJyD12jg4Mb7rHM8zK5aaw';
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // Adding Custom  Marker
...
exports.updateProfile = exports.updatePassword = void 0;
...
var logoutBth = document.querySelector('.nav__el--logout');
var userDataForm = document.querySelector('.form-user-data');
var changePasswordForm = document.querySelector('.form-user-password'); // DELEGATIONS
...
if (logoutBth) logoutBth.addEventListener('click', _auth.logout);
...
if (changePasswordForm) {
  ...
  changePasswordForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updatePassword)(currentPass, newPass, confirmPass);
  });
}
